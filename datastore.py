...
class Datastore:
    ...
    def add_books(self):
        ...
        self.book_list.append(Book("Green Eggs and Ham", "Dr. Suess", "1200", True, date(2021, 5, 21)))
        self.book_list.append(Book("Goodnight Moon", "Margaret Wise Brown", "7006", True, date(2021, 6, 2)))
        self.book_list.append(Book("Charlotte's Web", "E.B. White", "2300",  False, "Available"))
        self.book_list.append(Book("The Lion, The Witch and The Wardrobe",  "C.S. Lewis",  "3005", True, date(2021, 5, 28)))
        ...
        self.book_list.append(Book("The Hobbit", "J.R.R. Tolkien", "4554", True, date(2021, 5, 30)))
        ...
        self.book_list.append(Book("The Little Prince", " Antoine de Saint-Exupéry", "1234", True, date(2021, 5, 4)))
        ...
        self.book_list.append(Book("The Little Prince", " Antoine de Saint-Exupéry","5664", True, date(2021, 6, 21)))
